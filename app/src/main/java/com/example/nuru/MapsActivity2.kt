   ...
   // lateinit var binding: MapsActivity
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_ConfirmLocation.setOnClickListener {
            ...
            var searchResult1: SearchResultEntity? = intent.getParcelableExtra<SearchResultEntity>(SEARCH_RESULT_EXTRA_KEY)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        var searchResult: SearchResultEntity? = intent.getParcelableExtra<SearchResultEntity>(SEARCH_RESULT_EXTRA_KEY)
